...
export default function ProductCard({ product }) {
    ...
    return (
        <>
            <div className="bg-white rounded-2xl shadow-md overflow-hidden group hover:shadow-2xl transition relative">
                ...
                <div className="p-4">
                    ...
                    <div className="flex justify-between items-center mt-3">
                        ...
                        <button
                            ...
                            className={`px-3 py-1 rounded text-white ${added ? "bg-green-500" : "bg-blue-500"
                                }`}
                        >
                            {added ? "Added ✔" : "Add"}
                        </button>
